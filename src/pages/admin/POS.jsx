      ...
      <div className="flex-1 space-y-4">
        <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100">
          <h2 className="text-xl font-black uppercase mb-4 flex items-center gap-2">
            <ShoppingCart /> Admin POS Terminal
          </h2>
          <div className="relative">
            ...
            <input
              ref={searchInputRef}
              type="text"
              className="w-full pl-12 pr-4 py-4 bg-slate-100 rounded-2xl focus:ring-2 ring-black outline-none font-bold text-black"
      ...
      <div className="w-full md:w-96 space-y-4">
        <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 space-y-4">
          ...
          <div className="space-y-3">
            <input
              type="text"
              className="w-full px-4 py-2 bg-slate-50 border border-slate-100 rounded-xl outline-none font-bold"
